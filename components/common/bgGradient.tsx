...
function BgGradient({ className }: { className?: string }) {
  return (
    <div
      aria-hidden="true"
    ...
    >
      ...
      <div
        ...
        className={cn(
          'absolute top-0 left-[calc(50%-20rem)] aspect-[1155/678]  w-[72rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-br from-blue-500 via-purple-500 to-cyan-500 opacity-5',
          className
        )}
      />
